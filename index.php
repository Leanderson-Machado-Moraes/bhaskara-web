...
<body>
    <div class="container">
    <div class="titulo">
        <h1 class="TBhaskara">Cálculo de Bhaskara!</h1>
...
<form  method="POST">
        ...
        if(isset($_POST['a']) || isset($_POST['b']) || isset($_POST['c'])){
          ...
          $delta = ($b*$b)-((4*$a)*$c);
          if($delta < 0){
            echo "<p style='font-size:14pt; margin-top:20px;'> Delta negativo, raiz inexistente. Logo não há cálculo de bhaskara!</p>";
          }else{
            $x1 = (-$b + sqrt ($delta)) / (2 * $a);
            $x2 = (-$b - sqrt ($delta)) / (2 * $a);
